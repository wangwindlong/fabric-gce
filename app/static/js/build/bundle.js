...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoItem = React.createClass({displayName: "TodoItem",
	    ...
	    render : function(){
	        ...
	        if(t.status == 0){
	            updateBtn =  React.createElement("button", {onClick: this.handleUpdate.bind(this,t.id,1), className: "btn btn-primary"}, "Done")
	        }else{
	            updateBtn = React.createElement("button", {onClick: this.handleUpdate.bind(this,t.id,0), className: "btn btn-primary"}, "Undone")
	        }
	        ...
	        return (
	           React.createElement("tr", null, 
	               ...
	               React.createElement("td", null, 
	                   updateBtn, 
	                   React.createElement("button", {onClick: this.handleDelete.bind(this,t.id), className: "btn btn-danger"}, "Delete")
	               )
	           )
	        )
	    }
